<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:pd4ml="http://pd4ml.com">
    ...
    <xsl:template match="/">
        <xsl:for-each select="//Check">
            <div style="box-sizing:content-box;padding-top:10px;padding-left:10px;padding-right:10px;padding-bottom:6px;width:771px;height:309.5px;margin-left:15px;margin-right:15px;">
                <!--Header-->
                ...
                <!--Footer-->
                <div style="width: 771px;height: 29.5px;text-align:center;">
                    <table style="width:660px; height: 29px;">
                        <tr>
